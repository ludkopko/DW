...
public class Turma implements Serializable {
    ...
    @Column(name = "horariofim_tuma")
    @Temporal(TemporalType.TIME)
    private Date horariofimTuma;
    ...
    public Date getHorariofimTuma() {
        return horariofimTuma;
    }

    public void setHorariofimTuma(Date horariofimTuma) {
        this.horariofimTuma = horariofimTuma;
    }
